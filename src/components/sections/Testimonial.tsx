    ...
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      >
        ...
        <blockquote className="text-2xl font-medium text-gray-900 mb-8">
          "Благодаря Vitacaps я вернулась к полноценной жизни. Это не просто препарат – 
          это возможность снова чувствовать себя здоровой и счастливой. Я благодарна 
          за каждый день без боли и дискомфорта."
        </blockquote>
